...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--genimage', default=True)
        parser.add_argument('--exam_dir', default="./logsnew")
        ...
        parser.add_argument('--name', type=str, default='blur_jpg_prob0.1_debug', help='name of the experiment. It decides where to store samples and models')
